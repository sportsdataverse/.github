...
The reverse of `sdv-port-r-to-python`. Same failure mode, same fix: make the divergence a
...
- `sdv-port-r-to-python` — the reverse direction (R → sdv-py polars).
